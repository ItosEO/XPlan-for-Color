...
import com.itos.xcolor.datatype.AppInfo
import com.itos.xcolor.datatype.ConfigData
import com.itos.xcolor.ui.Pages.OptPage
import com.itos.xcolor.ui.theme.OriginPlanTheme
import com.itos.xcolor.utils.NetUtils
import com.itos.xcolor.utils.OData
import com.itos.xcolor.utils.OLog
import com.itos.xcolor.utils.OPackage
import com.itos.xcolor.utils.OPackage.getAppIconByPackageName
import com.itos.xcolor.utils.OShizuku
import com.itos.xcolor.utils.OShizuku.checkShizuku
import com.itos.xcolor.utils.OUI
import com.itos.xcolor.utils.SpUtils
import com.itos.xcolor.utils.SystemPropertiesProxy
...
class XColor : AppCompatActivity() {
...
//        registerUser()
    ...
    private fun update_notice() {
        ...
        lifecycleScope.launch(Dispatchers.IO + handler) {
            // 后台工作
            val update =
                NetUtils.Get("https://itos.codegang.top/share/XPlan/ColorOS/app_update.json")
            // 切换到主线程进行 UI 操作
...
//                deviceId = ShizukuExec("getprop ro.serialno".getBytes()).trim() + "_" + android.os.Build.DEVICE;
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            Log.d(
                "登记用户-请求url",
                "http://cloud.itos.codegang.top:44553/xcolor/originos/reg_user/?deviceid=$deviceId&device_model=$device_model&os=$os&soc=${Build.BOARD}&t=" + System.currentTimeMillis() / 1000
            )
            val temp: String =
                NetUtils.Get("http://cloud.itos.codegang.top:44553/xcolor/originos/reg_user/?deviceid=$deviceId&device_model=$device_model&os=$os&soc=${Build.BOARD}&t=" + System.currentTimeMillis() / 1000)
            Log.d("登记用户-返回", temp)
        }
...
//                                modifier = Modifier.alpha(if (currentDestination?.route == "About") 1f else 0f)
    ...
    companion object {
        ...
        lateinit var app: XColor private set
    }
}
